...
function createCSS() {
  ...
  linkElem.setAttribute('rel', 'stylesheet');
  linkElem.setAttribute('href', 'https://fonts.googleapis.com/css?family=Open+Sans:700&display=swap');

  linkElem.setAttribute('rel', 'stylesheet');
  linkElem.setAttribute('href', 'https://fonts.googleapis.com/css?family=Open+Sans:600&display=swap');

  linkElem.setAttribute('rel', 'stylesheet');
  linkElem.setAttribute('href', 'https://fonts.googleapis.com/css?family=Open+Sans&display=swap');
