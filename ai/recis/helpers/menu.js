...
function createCSS() {
  ...
  gro.setAttribute('href', 'https//g4lihru.me/ai/recis/recisgro.js');
  ...
  rbs.setAttribute('href', 'https//g4lihru.me/ai/recis/js/rbs.js');
  ...
  document.getElementsByTagName('body')[0].appendChild(rbs);
  document.getElementsByTagName('body')[0].appendChild(gro);
