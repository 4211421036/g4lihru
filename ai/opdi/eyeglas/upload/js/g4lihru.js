...
vaiitemp.innerHTML = `
    ...
    <style>
        ...
        <script type="text/javascript">
            setTimeout(function() {
                document.getElementById("loader-wrapper").style.display = "content";
            }, 2000);
        </script>
        <script type="text/javascript">
            // Get the modal
