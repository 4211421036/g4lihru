...
class OpdiApp extends HTMLElement {
    constructor() {
        ...
        tr.setAttribute('class', 'scope-text'), tr.id = 'scope-tx', tr.innerText = 'sebelum kamu memasuki sebuah test eye alangkah baiknya kamu segera mengisi quesioner diatas karena ini akan berhubungan dengan hasilnya nanti';
        r.appendChild(tr)
