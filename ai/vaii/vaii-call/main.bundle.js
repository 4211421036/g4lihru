(() => {
    ...
    const k = Object.freeze({ Home: { path: "/", component: "home-page", title: "Home" }, Room: { path: "/room", component: "vaii-room-page", title: "Room" }, About: { path: "/about", component: "about-page", title: "About" } });
