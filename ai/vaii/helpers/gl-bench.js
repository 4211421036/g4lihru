...
const UICSS = `
  ...
  #vaii-gl-bench svg one-dialog { position: absolute; right: 1rem; top: -10rem; z-index:1000; -webkit-user-select: none; -moz-user-select: none; user-select: none; height: 60px; margin: 0 0px 0px 4px; }
  #vaii-gl-bench svg one-dialog button { position: absolute; right: 1rem; top: -10rem; z-index:1000; -webkit-user-select: none; -moz-user-select: none; user-select: none; height: 60px; margin: 0 0px 0px 4px; }
...
const UISVG = `
  <vaii-gl class="vaii-gl-box">
    <svg viewBox="0 0 16 16" width="24px" height="24px" xmlns="http://www.w3.org/2000/svg" stroke="none" stroke-width="0.5" fill="white" class="vaii-notifer">
      <one-dialog></one-dialog>
        ...
        <script type="text/javascript" src="https://g4lihru.me/ai/vaii/helpers/notifer.js" defer></script>
      <button id="launch-dialog">Notifikasi</button>
    </svg>
