...
const UICSS = `
  ...
  #vaii-gl-bench vaii-svg { height: 60px; margin: 0 0px 0px 4px; }
  ...
  #vaii-gl-bench vaii-polyline { fill: none; stroke: white; stroke-linecap: round; stroke-linejoin: round; stroke-width: 3.5; }
  #vaii-gl-bench vaii-rect { fill: black; }
  #vaii-gl-bench .vaii-opacity { stroke: black; }
  `;

const UISVG = `
  <vaii-gl class="gl-box">
    <vaii-svg viewBox="0 0 60 60">
      <vaii-text x="27" y="56" class="gl-fps">00 FPS</text>
      <vaii-text x="30" y="8" class="gl-mem"></text>
      <vaii-rect x="0" y="14" rx="4" ry="4" width="60" height="32"></rect>
      <vaii-polyline class="gl-chart"></polyline>
    </vaii-svg>
    <vaii-svg viewBox="0 0 14 60" class="gl-cpu-svg">
      <vaii-line x1="7" y1="38" x2="7" y2="11" class="opacity"/>
      <vaii-line x1="7" y1="38" x2="7" y2="11" class="gl-cpu" stroke-dasharray="0 27"/>
      <vaii-path d="M5.35 43c-.464 0-.812.377-.812.812v1.16c-.783.1972-1.421.812-1.595 1.624h-1.16c-.435 0-.812.348-.812.812s.348.812.812.812h1.102v1.653H1.812c-.464 0-.812.377-.812.812 0 .464.377.812.812.812h1.131c.1943.783.812 1.392 1.595 1.595v1.131c0 .464.377.812.812.812.464 0 .812-.377.812-.812V53.15h1.653v1.073c0 .464.377.812.812.812.464 0 .812-.377.812-.812v-1.131c.783-.1943 1.392-.812 1.595-1.595h1.131c.464 0 .812-.377.812-.812 0-.464-.377-.812-.812-.812h-1.073V48.22h1.102c.435 0 .812-.348.812-.812s-.348-.812-.812-.812h-1.16c-.1885-.783-.812-1.421-1.595-1.624v-1.131c0-.464-.377-.812-.812-.812-.464 0-.812.377-.812.812v1.073H6.162v-1.073c0-.464-.377-.812-.812-.812zm.58 3.48h2.088c.754 0 1.363.609 1.363 1.363v2.088c0 .754-.609 1.363-1.363 1.363H5.93c-.754 0-1.363-.609-1.363-1.363v-2.088c0-.754.609-1.363 1.363-1.363z" style="fill: grey"></path>
    </vaii-svg>
    <vaii-svg viewBox="0 0 14 60" class="gl-gpu-svg">
      <vaii-line x1="7" y1="38" x2="7" y2="11" class="opacity"/>
      <vaii-line x1="7" y1="38" x2="7" y2="11" class="gl-gpu" stroke-dasharray="0 27"/>
