...
const UICSS = `
  ...
  #vaii-gl-menu { position: absolute; right: 1rem; bottom: 1rem; z-index:1000; -webkit-user-select: none; -moz-user-select: none; user-select: none; }
  #vaii-gl-menu vaii-menu { position: relative; display: block; margin: 4px; padding: 0 2px 0 2px; background: #303030; border-radius: 0.1rem; cursor: pointer; opacity: 0.9; }
  #vaii-gl-menu svg { height: 60px; margin: 0 0px 0px 4px; }
  `;

const UISVG = `
  <vaii-gl class="vaii-gl-box">
    <vaii-menu id="vaii-gl-menu>
