...
const UICSS = `
  ...
  #vaii-gl-bench svg a { position: absolute; right: 1rem; top: -10rem; z-index:1000; -webkit-user-select: none; -moz-user-select: none; user-select: none; height: 60px; margin: 0 0px 0px 4px; }
...
const UISVG = `
  <vaii-gl class="vaii-gl-box">
    <svg viewBox="0 0 16 16" width="24px" height="24px" xmlns="http://www.w3.org/2000/svg" stroke="none" stroke-width="0.5" fill="white" class="vaii-notifer">
      <a href="javascript (0)" id="notifer">
