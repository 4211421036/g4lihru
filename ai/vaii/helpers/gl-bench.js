...
const UICSS = `
  ...
  #vaii-gl-bench a { position: absolute; right: 1rem; top: 1rem; z-index:1000; -webkit-user-select: none; -moz-user-select: none; user-select: none; height: 60px; margin: 0 0px 0px 4px; }
  #vaii-gl-bench a svg { position: absolute; right: 1rem; top: 1rem; z-index:1000; -webkit-user-select: none; -moz-user-select: none; user-select: none; height: 60px; margin: 0 0px 0px 4px; }
