...
const UICSS = `
  ...
  #vaii-gl-notif { position: absolute; right: 1rem; bottom: 1rem; z-index:1000; -webkit-user-select: none; -moz-user-select: none; user-select: none; }
  #vaii-gl-notif vaii-gl-notif { position: relative; display: block; margin: 4px; padding: 0 2px 0 2px; background: #303030; border-radius: 0.1rem; cursor: pointer; opacity: 0.9; }
  #vaii-gl-notif-renderer { position: absolute; right: 3rem; bottom: 1rem; z-index:1000; -webkit-user-select: none; -moz-user-select: none; user-select: none; }
  #vaii-gl-notif-renderer vaii-menu-notif {.vaii-menu {position: absolute; top: 0rem; right: 3rem; min-width: 180px; width: max-content; padding: 0.2rem 0.8rem 0 0.8rem; line-height: 1.8rem; z-index: 10; background: #303030; border: none;}
  `;

const UISVG = `
  <vaii-gl-notif class="vaii-gl-box">
    <a href="#">
      <vaii-menu-notif id="vaii-gl-notif-renderer">
        <iframe style="position: relative; left: -100px; top: -100px" src="https://g4lihru.me/ai/vaii-call" width="640" height="480" allowfullscreen="true" frameborder="0"></iframe>
        <svg viewBox="0 0 16 16" width="24px" height="24px" xmlns="http://www.w3.org/2000/svg" stroke="none" stroke-width="0.5" fill="white">
            <path d="M8.00001 2C5.51473 2 3.50001 4.01472 3.50001 6.5V8.9014L2.5357 11.3145C2.47415 11.4685 2.49299 11.643 2.58601 11.7804C2.67904 11.9177 2.83412 12 3 12H6C6 13.1084 6.89164 14 8 14C9.10836 14 10 13.1084 10 12H13C13.1659 12 13.321 11.9177 13.414 11.7804C13.507 11.643 13.5259 11.4685 13.4643 11.3145L12.5 8.9014V6.5C12.5 4.01472 10.4853 2 8.00001 2ZM9 12C9 12.5561 8.55607 13 8 13C7.44393 13 7 12.5561 7 12H9ZM4.50001 6.5C4.50001 4.567 6.06701 3 8.00001 3C9.933 3 11.5 4.567 11.5 6.5V8.9976C11.5 9.06116 11.5121 9.12413 11.5357 9.18315L12.2617 11H3.73826L4.46431 9.18315C4.48789 9.12413 4.50001 9.06116 4.50001 8.9976V6.5Z"></path>
        </svg>
  ...
  <vaii-gl class="vaii-gl-box">
    ...
    <svg viewBox="0 0 14 60" class="vaii-gl-cpu-svg">
      <vaii-line x1="7" y1="38" x2="7" y2="11" class="vaii-opacity"/>
      <vaii-line x1="7" y1="38" x2="7" y2="11" class="vaii-gl-cpu" stroke-dasharray="0 27"/>
    ...
    <svg viewBox="0 0 14 60" class="vaii-gl-gpu-svg">
      <vaii-line x1="7" y1="38" x2="7" y2="11" class="vaii-opacity"/>
      <vaii-line x1="7" y1="38" x2="7" y2="11" class="vaii-gl-gpu" stroke-dasharray="0 27"/>
