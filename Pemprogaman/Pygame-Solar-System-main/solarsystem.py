...
with open(r"C:\Users\asus\public\unnes-py\Pygame-Solar-System-main\settings.json", "r") as file:
    SETTINGS = json.load(file)
with open(r"C:\Users\asus\public\unnes-py\Pygame-Solar-System-main\bodies.json", "r") as file:
