...
while True:
    ...
    for (x, y, w, h) in faces:
        ...
        cv2.putText(frame, f'wajah 1', (x,y-30), cv2.FONT_HERSHEY_SIMPLEX, 1, (166,178,16), 1)
        person += 1
    ...
    cv2.putText(frame, f'Total Wajah : 0', (40,70), cv2.FONT_HERSHEY_DUPLEX, 0.8, (197,210,18), 2)
